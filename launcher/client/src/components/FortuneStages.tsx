...
import { LauncherStageStatus } from './types';

const STAGES = [
  { status: LauncherStageStatus.UNAUTHORIZED, title: 'Funding Method' },
  { status: LauncherStageStatus.GROUP_REQUEST, title: 'Group Request' },
  { status: LauncherStageStatus.LAUNCH, title: 'Launch' },
];
