    ...
    <div>
      <Box sx={{ height: '100vh', background: 'white' }}>
        ...
        <div style={{ marginTop: '5rem' }}>
          ...
          <p style={{color:'black',fontWeight:'bold',margin:'0.5rem 4rem'}}>Escrow balance $500</p>
          <Stack
            direction="row"
            spacing={2}
            sx={{
          ...
          >
           <div>
            <p style={{color:'black',fontWeight:'bold',marginBottom:'1rem'}}>Inbound (26)</p>
           <Box
              sx={{
                height: 400,
                width: 300,
           ...
           <div>
           <p style={{color:'black',fontWeight:'bold',marginBottom:'1rem'}}>No Risk (1000)</p>
           <Box
              sx={{
                height: 400,
                width: 300,
           ...
           <div>
           <p style={{color:'black',fontWeight:'bold',marginBottom:'1rem'}}>Risk (400)</p>
           <Box
              sx={{
                height: 400,
                width: 300,
